<?php
  ...
  if(mysqli_num_rows($result)>0){//checks if any rows were selected
	...
	while($row=mysqli_fetch_assoc($result)){//fetches records
      ...
      echo '<div class="col col-sm-6 col-md-6 col-lg-3 my-2">
      			<!--https://getbootstrap.com/docs/5.1/components/card/-->
      			<div class="card mx-auto text-center shadow" itemid="'.$row["ItemId"].'">
                  <!--card image-->
    ...
    if($index==3){//checks if odd index
      echo '<div class="col col-sm-6 col-md-6 col-lg-3 my-1"></div>';
    }
    echo '</div>
    </div>';
  }
